...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/file/master/_listings/aws-rds/apis.md
...
- name: AWS RDS API - Describe D B Log Files
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/file/master/_listings/aws-rds/actiondescribedblogfiles-get-openapi.md
- name: AWS RDS API - Describe D B Log Files
  x-api-slug: actiondescribedblogfiles-get
  description: Returns a list of DB log files for the DB instance.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/Database_AmazonRDS.png
...
- name: AWS RDS API - Download D B Log File Portion
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/file/master/_listings/aws-rds/actiondownloaddblogfileportion-get-openapi.md
- name: AWS RDS API - Download D B Log File Portion
  x-api-slug: actiondownloaddblogfileportion-get
  description: Downloads all or a portion of the specified log file, up to 1 MB in
    size.
